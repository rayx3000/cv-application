  ...
  return (
     <form>
        ...
        <fieldset>
          ...
          <input type="text" id="certification" name="name" placeholder='e.g AWS Certified Solutions Architect' value={newCert.name || ''} onChange={handleChange} />
          <label htmlFor="issuer">Issuing Organization:</label>
          <input type="text" id="issuer" name="company" placeholder='e.g Amazon Web Services' value={newCert.company || ''} onChange={handleChange} />
          <label htmlFor="date">Date Earned:</label>
          <input type="date" id="date" name="date" value={newCert.date || ''} onChange={handleChange} />
          <label htmlFor="description">Description:</label>
          <textarea id="description" name="desc" placeholder='Type your experience here...' value={newCert.desc || ''} onChange={handleChange}></textarea>
        </fieldset>
